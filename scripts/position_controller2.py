...
class Control:
    def __init__(self):
        ...
        rospy.Subscriber("/edrone/err_y_m", Bool, self.destination_cmd_callback)
    ...
    def cmd(self):
        ...
        if True:
            ...
            self.control_cmd.rcYaw = math.degrees(math.atan(self.output[0]/self.output[0]))

            # converting 0, pi/2 to 1000 to 2000
            self.control_cmd.rcYaw = ((self.control_cmd.rcYaw * 1000) / (math.pi/2)) + 1000
